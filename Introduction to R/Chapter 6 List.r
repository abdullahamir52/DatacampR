...
# your to-do lists can contain different categories of tasks. This chapter 
# will teach you how to create, name, and subset these lists.
...
# of activity that has to be done.
...
# what the components of your list stand for. That is why you should give 
# names to them:
...
# components. Use for my_vector the name vec, for my_matrix the name mat and 
# for my_df the name df.
...
# the variables mov, act and rev in your R workspace. Feel free to check them 
# out in the console.

# Complete the code on the right to create shining_list; it contains three 
# elements:
...
# (names are moviename, actors and reviews).
...
# from the second component, actors (shining_list[[2]]), the first element 
# ([1]). When you type this in the console, you will see the answer is 
# Jack Nicholson.

# Select from shining_list the vector representing the actors. 
# Simply print out this vector.

# Select from shining_list the second element in the vector representing 
# the actors. Do a printout like before.
...
# It would be useful to collect together all the pieces of information about 
# the movie, like the title, actors, and reviews into a single variable. 
# Since these pieces of data are different shapes, it is natural to combine 
