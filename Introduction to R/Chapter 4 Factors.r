...
# perhaps a few more options for people who color their hair. In R, 
# categorical data is stored in factors. Factors are very important in 
...
# categories. A continuous variable, on the other hand, can correspond to 
...
# future treat both types differently. (You will see later why this is 
# the case.)

# A good example of a categorical variable is sex. In many circumstances you 
# can limit the sex categories to "Male" or "Female". (Sometimes you may 
# need different categories. For example, you may need to consider 
...
# that you have to do is create a vector that contains all the observations 
# that belong to a limited number of categories. For example, sex_vector 
...
# other'. For example, think of the categorical variable animals_vector with 
# the categories "Elephant", "Giraffe", "Donkey" and "Horse". Here, it is 
# impossible to say that one stands above or below the other. 
...
# "Low", "Medium" and "High". Here it is obvious that "Medium" stands 
# above "Low", and "High" stands above "Medium".

# Click 'Submit Answer' to check how R constructs and prints nominal and 
...
# names of these levels for clarity or other reasons. R allows you to do this 
...
# (You usually need more categories for survey data; either way, you use a 
# factor to store the categorical data.)

# survey_vector <- c("M", "F", "F", "M", "M")
# Recording the sex with the abbreviations "M" and "F" can be convenient if you 
# are collecting data with pen and paper, but it can introduce confusion when 
...
# type levels(factor_survey_vector), you'll see that it outputs [1] "F" "M". 
# If you don't specify the levels of the factor when creating the vector, R 
# will automatically assign them alphabetically. To correctly map "F" to 
# "Female" and "M" to "Male", the levels should be set to c("Female", "Male"), 
# in this order.
...
# summary(my_var)
# Going back to our survey, you would like to know how many "Male" responses 
# you have in your study, and how many "Female" responses. The summary() 
# function gives you the answer to this question.

# Ask a summary() of the survey_vector and factor_survey_vector. Interpret the 
...
# In factor_survey_vector you have a factor with two levels: "Male" and 
# "Female". But how does R value these relative to each other?

# Read the code in the editor and click 'Submit Answer' to test if male is 
# greater than (>) female. 
...
# that you want to evaluate their performance. To do this, you track their 
# speed, evaluate each analyst as "slow", "medium" or "fast", and save the 
...
# speed_vector into an unordered factor. To create an ordered factor, you 
# have to add two additional arguments: ordered and levels.
...
# Having a bad day at work, 'data analyst number two' enters your office and 
# starts complaining that 'data analyst number five' is slowing down the 
# entire project. Since you know that 'data analyst number two' has the 
# reputation of being a smarty-pants, you first decide to check if his 
# statement is true.
...
# Use [2] to select from factor_speed_vector the factor value for the 
# second data analyst. Store it as da2.
# Use [5] to select the factor_speed_vector factor value for the fifth 
# data analyst. Store it as da5.
# Check if da2 is greater than da5; simply print out the result. Remember 
# that you can use the > operator to check whether one element is larger 
# than the other.
